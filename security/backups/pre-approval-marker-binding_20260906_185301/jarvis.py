...
async def approve(request: ApprovalRequest):
    ...
    # Approved execution is capability-bound.
    # The approval token carries the capability and arguments resolved by JARVIS.
    # No natural-language command is reinterpreted into a shell command here.
