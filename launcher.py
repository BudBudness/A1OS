...
log_path = os.path.expanduser('~/A1OS_RESTORED/logs/kernel.log')
logging.basicConfig(level=logging.INFO, filename=log_path)

def bootstrap():
    registry_path = os.path.expanduser('~/A1OS_RESTORED/cfg/registry.json')
    ...
    for category, domains in registry.items():
        for domain in domains:
            ...
            domain_data_path = os.path.expanduser(f'~/A1OS_RESTORED/data/{domain}')
